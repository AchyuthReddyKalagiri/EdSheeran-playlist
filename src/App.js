...
class App extends Component {
  ...
  deleteTrack = id => {
    ...
    const filteredTracks = trackList.filter(each => each.id === 1)
  ...
  render() {
    ...
    const finalList = trackList.filter(each =>
      each.name.toUpperCase().includes(searchInput.toUpperCase()),
    )
    return (
